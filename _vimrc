...
"透明
"au GUIEnter * call libcallnr("vimtweak.dll", "SetAlpha",185)

"set fencs=gb1830,utf-8,ucs-bom,shift-jis,gbk,gb2312,cp936
...
winpos 205 105          " 设定窗口位置  
set lines=35 columns=85    " 设定窗口大小  
set nu              " 显示行号  
"set go=             " 不要图形按钮  
"color asmanian2     " 设置背景主题  
""set guifont=Courier_New:h15:cANSI   " 设置字体  
set guifont=Source_Code_Pro:h45:cANSI
syntax on           " 语法高亮  
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "\# Author:       qinchuan") 
		call append(line(".")+2, "\# mail:         pony1993@126.com") 
	...
	if &filetype == 'cpp'
        ...
        call append(line(".")+12,"#include <iomanip>")
		...
		call append(line(".")+18,"#define LL long long")
		call append(line(".")+19,"using namespace std;")
		call append(line(".")+20,"")
        call append(line(".")+21,"int main(){")
        call append(line(".")+22,"    #ifndef ONLINE_JUDGE")
        call append(line(".")+23,"        freopen(,, stdin);")
